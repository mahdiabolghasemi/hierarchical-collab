...
train_data<- min480_n %>% filter(Time < as.Date("2020-09-01")) %>% filter(!is_aggregated(Subgroup))
train_label<- min480_n %>% filter(Time < as.Date("2020-09-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

valid_data <- min480_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup))
valid_label<- min480_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)
...
### 240 hyperparameters ####
train_data<- min240_n %>% filter(Time < as.Date("2020-09-01")) %>% filter(!is_aggregated(Subgroup))
train_label<- min240_n %>% filter(Time < as.Date("2020-09-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

valid_data <- min240_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup))
valid_label<- min240_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)
...
train_data<- min160_n %>% filter(Time < as.Date("2020-09-01")) %>% filter(!is_aggregated(Subgroup))
train_label<- min160_n %>% filter(Time < as.Date("2020-09-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

valid_data <- min160_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup))
valid_label<- min160_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

bayes_result_160 <- BayesianOptimization(optimize_function,
                                         bounds = bounds,
                                         init_points = 40,  # Number of randomly chosen points to sample the target function before fitting the Gaussian process (GP)
...
train_data<- min120_n %>% filter(Time < as.Date("2020-09-01")) %>% filter(!is_aggregated(Subgroup))
train_label<- min120_n %>% filter(Time < as.Date("2020-09-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

valid_data <- min120_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup))
valid_label<- min120_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)
...
train_data<- min80_n %>% filter(Time < as.Date("2020-09-01")) %>% filter(!is_aggregated(Subgroup))
train_label<- min80_n %>% filter(Time < as.Date("2020-09-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

valid_data <- min80_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup))
valid_label<- min80_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)
...
train_data<- min60_n %>% filter(Time < as.Date("2020-09-01")) %>% filter(!is_aggregated(Subgroup))
train_label<- min60_n %>% filter(Time < as.Date("2020-09-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

valid_data <- min60_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup))
valid_label<- min60_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)
...
train_data<- min40_n %>% filter(Time < as.Date("2020-09-01")) %>% filter(!is_aggregated(Subgroup))
train_label<- min40_n %>% filter(Time < as.Date("2020-09-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

valid_data <- min40_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup))
valid_label<- min40_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)
...
train_data<- min30_n %>% filter(Time < as.Date("2020-09-01")) %>% filter(!is_aggregated(Subgroup))
train_label<- min30_n %>% filter(Time < as.Date("2020-09-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

valid_data <- min30_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup))
valid_label<- min30_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)
...
train_data<- min20_n %>% filter(Time < as.Date("2020-09-01")) %>% filter(!is_aggregated(Subgroup))
train_label<- min20_n %>% filter(Time < as.Date("2020-09-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

valid_data <- min20_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup))
valid_label<- min20_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2020-10-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)
...
train_data<- min10_n %>% filter(Time < as.Date("2020-09-01")) %>% filter(!is_aggregated(Subgroup))
train_label<- min10_n %>% filter(Time < as.Date("2020-09-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)

valid_data <- min10_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2021-10-01"))  %>% filter(!is_aggregated(Subgroup))
valid_label<- min10_n %>% filter(Time > as.Date("2020-09-01") & Time < as.Date("2021-10-01"))  %>% filter(!is_aggregated(Subgroup)) %>% pull(Power)
...
saveRDS(fc_lgbm_10,"fc_lgbm_10.rds")
...
saveRDS(fc_lgbm_20,"fc_lgbm_20.rds")
...
saveRDS(fc_lgbm_30,"fc_lgbm_30.rds")
...
for (i in seq(N_40,N_40_all-12,12)) {
  ...
  fit_m1 <- min40_n %>%
    group_by(Group, Subgroup) %>%
    slice_head(n = i) %>%
    model(mod1 = lgbm(formula=formula, para_bayes= bayes_opt_result_40)) 
...
saveRDS(fitted_m1_lgbm_40, file = "fc40_m2_lgbm_fitted.rds")
saveRDS(residuals_m1_lgbm_40, file = "fc40_m2_lgbm_residuals.rds")

saveRDS(res_fit_all_lgbm_40,"res_fit_all_lgbm_40.rds")
saveRDS(fc_lgbm_40,"fc_lgbm_m2_40.rds")
...
saveRDS(fc_lgbm_60,"fc_lgbm_m2_60.rds")
...
saveRDS(fc_lgbm_80,"fc_lgbm_m2_80.rds")
...
saveRDS(fc_lgbm_120,"fc_lgbm_m2_120.rds")
...
saveRDS(fc_lgbm_160,"fc_lgbm_m2_160.rds")
...
saveRDS(fc_lgbm_240,"fc_lgbm_m2_240.rds")
...
for (i in seq(N_480,N_480_all-1,1)) {
  ...
  fit_m1 <- min480_n %>%
    group_by(Group, Subgroup) %>%
    #slice_head(n = i) %>%
    model(mod1 = lgbm(formula=formula, para_bayes= bayes_opt_result_480)) 
...
saveRDS(fc_lgbm_480,"fc_lgbm_m2_480.rds")
