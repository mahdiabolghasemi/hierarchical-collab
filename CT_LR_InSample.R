...
turbineA1 <- readr::read_csv("Turbine_Data_Penmanshiel_01_2020-01-01_-_2021-01-01_1042.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A1") %>% slice_head(n=52680) %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_01_2021-01-01_-_2021-07-01_1042.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A1") %>% slice_head(n=12960))
...
turbineA2 <- readr::read_csv("Turbine_Data_Penmanshiel_02_2020-01-01_-_2021-01-01_1043.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A2") %>% slice_head(n=52680) %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_02_2021-01-01_-_2021-07-01_1043.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A2") %>% slice_head(n=12960))
...
turbineA4 <- readr::read_csv("Turbine_Data_Penmanshiel_04_2020-01-01_-_2021-01-01_1044.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A4") %>% slice_head(n=52680) %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_04_2021-01-01_-_2021-07-01_1044.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A4") %>% slice_head(n=12960))
...
turbineA5 <- readr::read_csv("Turbine_Data_Penmanshiel_05_2020-01-01_-_2021-01-01_1045.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A5") %>% slice_head(n=52680) %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_05_2021-01-01_-_2021-07-01_1045.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A5") %>% slice_head(n=12960))
...
turbineA6 <- readr::read_csv("Turbine_Data_Penmanshiel_06_2020-01-01_-_2021-01-01_1046.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A6") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_06_2021-01-01_-_2021-07-01_1046.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A6") %>% slice_head(n=12960))
...
turbineA7 <- readr::read_csv("Turbine_Data_Penmanshiel_07_2020-01-01_-_2021-01-01_1047.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A7") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_07_2021-01-01_-_2021-07-01_1047.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A7") %>% slice_head(n=12960))
...
turbineA8 <- readr::read_csv("Turbine_Data_Penmanshiel_08_2020-01-01_-_2021-01-01_1048.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A8") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_08_2021-01-01_-_2021-07-01_1048.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A8") %>% slice_head(n=12960))
...
turbineA9 <- readr::read_csv("Turbine_Data_Penmanshiel_09_2020-01-01_-_2021-01-01_1049.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A9") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_09_2021-01-01_-_2021-07-01_1049.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A9") %>% slice_head(n=12960))
...
turbineA10 <- readr::read_csv("Turbine_Data_Penmanshiel_10_2020-01-01_-_2021-01-01_1050.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A10") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_10_2021-01-01_-_2021-07-01_1050.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A10") %>% slice_head(n=12960))
...
turbineA11 <- readr::read_csv("Turbine_Data_Penmanshiel_11_2020-01-01_-_2021-01-01_1051.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A11") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_11_2021-01-01_-_2021-07-01_1051.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A11") %>% slice_head(n=12960))
...
turbineA12 <- readr::read_csv("Turbine_Data_Penmanshiel_12_2020-01-01_-_2021-01-01_1052.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A12") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_12_2021-01-01_-_2021-07-01_1052.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A12") %>% slice_head(n=12960))
...
turbineA13 <- readr::read_csv("Turbine_Data_Penmanshiel_13_2020-01-01_-_2021-01-01_1053.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A13") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_13_2021-01-01_-_2021-07-01_1053.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A13") %>% slice_head(n=12960))
...
turbineA14 <- readr::read_csv("Turbine_Data_Penmanshiel_14_2020-01-01_-_2021-01-01_1054.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A14") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_14_2021-01-01_-_2021-07-01_1054.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A14") %>% slice_head(n=12960))
...
turbineA15 <- readr::read_csv("Turbine_Data_Penmanshiel_15_2020-01-01_-_2021-01-01_1056.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A15") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Penmanshiel_15_2021-01-01_-_2021-07-01_1056.csv") %>% select(1,2,62) %>% mutate(Group = "A", Subgroup = "A15") %>% slice_head(n=12960))
...
turbineB1 <- readr::read_csv("Turbine_Data_Kelmarsh_1_2020-01-01_-_2021-01-01_228.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B1") %>% slice_head(n=52680) %>%
  bind_rows(readr::read_csv("Turbine_Data_Kelmarsh_1_2021-01-01_-_2021-07-01_228.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B1") %>% slice_head(n=12960))
...
turbineB2 <- readr::read_csv("Turbine_Data_Kelmarsh_2_2020-01-01_-_2021-01-01_229.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B2") %>% slice_head(n=52680) %>%
  bind_rows(readr::read_csv("Turbine_Data_Kelmarsh_2_2021-01-01_-_2021-07-01_229.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B2") %>% slice_head(n=12960))
...
turbineB3 <- readr::read_csv("Turbine_Data_Kelmarsh_3_2020-01-01_-_2021-01-01_230.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B3") %>% slice_head(n=52680) %>%
  bind_rows(readr::read_csv("Turbine_Data_Kelmarsh_3_2021-01-01_-_2021-07-01_230.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B3") %>% slice_head(n=12960))
...
turbineB4 <- readr::read_csv("Turbine_Data_Kelmarsh_4_2020-01-01_-_2021-01-01_231.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B4") %>% slice_head(n=52680)  %>%
  bind_rows(readr::read_csv("Turbine_Data_Kelmarsh_4_2021-01-01_-_2021-07-01_231.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B4") %>% slice_head(n=12960))
...
turbineB5 <- readr::read_csv("Turbine_Data_Kelmarsh_5_2020-01-01_-_2021-01-01_232.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B5") %>% slice_head(n=52680) %>%
  bind_rows(readr::read_csv("Turbine_Data_Kelmarsh_5_2021-01-01_-_2021-07-01_232.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B5") %>% slice_head(n=12960))
...
turbineB6 <- readr::read_csv("Turbine_Data_Kelmarsh_6_2020-01-01_-_2021-01-01_233.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B6") %>% slice_head(n=52680) %>%
  bind_rows(readr::read_csv("Turbine_Data_Kelmarsh_6_2021-01-01_-_2021-07-01_233.csv") %>% select(1,2,62) %>% mutate(Group = "B", Subgroup = "B6") %>% slice_head(n=12960))
...
dataset <- dataset %>%
  mutate(PCTimeStamp=dmy_hm(PCTimeStamp)) %>%
  distinct(Group, Subgroup, PCTimeStamp, .keep_all = TRUE) %>%
  as_tsibble(index = PCTimeStamp, key = c("Group", "Subgroup"))
...
#dataset1 <- dataset %>% head(n=200000)
dataset <- fill_gaps(dataset, .full = TRUE)
dataset <- dataset %>%
  fill(-1, .direction = "downup")


#### form hierarchy from the source series ####
min10_power <- dataset %>%
  aggregate_key(Group/Subgroup, Power = sum(Power), Wind_Speed = mean(Wind_Speed)) %>% group_by_key()
...
min20_power <- min10_power %>%
  ...
  summarise(
    Power = sum(Power), Wind_Speed = mean(Wind_Speed)
  ) %>%
  group_by_key()
...
#30 minutely
min40_power_n <- min10_power %>%
  index_by(Time_n = ~ lubridate::floor_date(., "40 minutes")) %>%
  summarise(
    Power = sum(Power), Wind_Speed = mean(Wind_Speed)
  ) %>%
  group_by_key()
...
#40 minutely
min40_power <- min10_power %>%
  mutate(
    # Step 1: Calculate seconds since the start of the day
    seconds_since_start = as.numeric(difftime(Time, floor_date(Time, "day"), units = "secs")),
    # Step 2: Round to nearest 2400 seconds (40 minutes)
    rounded_seconds = floor(seconds_since_start / 2400) * 2400,
    # Convert back to POSIXct, adjusting for the date
    Time_n = floor_date(Time , "day") + seconds(rounded_seconds)
  ) %>%
  index_by(Time_n) %>%
  summarise(
    Power = sum(Power),
...
#80 minutely
min80_power <- min10_power %>%
  mutate(
    # Step 1: Calculate seconds since the start of the day
    seconds_since_start = as.numeric(difftime(Time, floor_date(Time, "day"), units = "secs")),
    # Step 2: Round to nearest 4800 seconds (80 minutes)
    rounded_seconds = floor((seconds_since_start / 4800)) * 4800,
    # Convert back to POSIXct, adjusting for the date
    Time_n = floor_date(Time , "day") + seconds(rounded_seconds)
  ) %>%
  index_by(Time_n) %>%
...
min120_power <- min10_power %>%
  mutate(
    # Step 1: Calculate seconds since the start of the day
    seconds_since_start = as.numeric(difftime(Time, floor_date(Time, "day"), units = "secs")),
    # Step 2: Round to nearest 7200 seconds (120 minutes)
    rounded_seconds = floor(seconds_since_start / 7200) * 7200,
    # Convert back to POSIXct, adjusting for the date
    Time_n = floor_date(Time , "day") + seconds(rounded_seconds)
  ) %>%
  index_by(Time_n) %>%
...
min160_power <- min10_power %>%
  mutate(
    # Step 1: Calculate seconds since the start of the day
    seconds_since_start = as.numeric(difftime(Time, floor_date(Time, "day"), units = "secs")),
    # Step 2: Round to nearest 9600 seconds (160 minutes)
    rounded_seconds = floor(seconds_since_start / 9600) * 9600,
    # Convert back to POSIXct, adjusting for the date
    Time_n = floor_date(Time , "day") + seconds(rounded_seconds)
  ) %>%
  index_by(Time_n) %>%
...
min240_power <- min10_power %>%
  mutate(
    # Step 1: Calculate seconds since the start of the day
    seconds_since_start = as.numeric(difftime(Time, floor_date(Time, "day"), units = "secs")),
    # Step 2: Round to nearest 14400 seconds (240 minutes)
    rounded_seconds = floor(seconds_since_start / 14400) * 14400,
    # Convert back to POSIXct, adjusting for the date
    Time_n = floor_date(Time , "day") + seconds(rounded_seconds)
  ) %>%
  index_by(Time_n) %>%
...
min360_power <- min10_power %>%
  mutate(
    # Step 1: Calculate seconds since the start of the day
    seconds_since_start = as.numeric(difftime(Time, floor_date(Time, "day"), units = "secs")),
    # Step 2: Round to nearest 21600 seconds (360 minutes)
    rounded_seconds = floor(seconds_since_start / 21600) * 21600,
    # Convert back to POSIXct, adjusting for the date
    Time_n = floor_date(Time , "day") + seconds(rounded_seconds)
  ) %>%
  index_by(Time_n) %>%
...
min480_power <- min10_power %>%
  mutate(
    # Step 1: Calculate seconds since the start of the day
    seconds_since_start = as.numeric(difftime(Time, floor_date(Time, "day"), units = "secs")),
    # Step 2: Round to nearest 28800 seconds (480 minutes)
    rounded_seconds = floor(seconds_since_start / 28800) * 28800,
    # Convert back to POSIXct, adjusting for the date
    Time_n = floor_date(Time , "day") + seconds(rounded_seconds)
  ) %>%
  index_by(Time_n) %>%
...
saveRDS(min40_power, file = "min40.rds")
saveRDS(min60_power, file = "min60.rds")
saveRDS(min80_power, file = "min80.rds")
saveRDS(min120_power, file = "min120.rds")
saveRDS(min160_power, file = "min160.rds")
saveRDS(min240_power, file = "min240.rds")
saveRDS(min480_power, file = "min480.rds")
...
for (i in seq(N_10,N_10_all-48,48)) {
  ...
  fc_lr_10 <- bind_rows(fc_lr_10,fc)
  
  # extract fitted and residuals
  fitted_m1_10 <- fit_m1 %>% fitted() %>% as_tibble()
  residuals_m1_10 <- fit_m1 %>%  residuals() %>% as_tibble()
  res_fit_all_10 <- bind_rows(res_fit_all_10,bind_cols(fitted_m1_10,res=residuals_m1_10$.resid,iteration=i))
pb$tick()
}

end_time_10 <- Sys.time()

#saveRDS(fitted_m1_10, file = "fc10_m1_lr_fitted.rds")
#saveRDS(residuals_m1_10, file = "fc10_m1_lr_residuals.rds")

saveRDS(res_fit_all_10, "res_fit_all_10.rds")
saveRDS(fc_lr_10, "fc_m1_lr_10.rds")
saveRDS(new_data_all_10, "new_data_all_10.rds")
...
for (i in seq(N_20,N_20_all-24,24)) {
  ...
  fc <-   fit_m1 %>%
    ...
    as_tibble() %>% bind_cols(Actual= min20_n %>%
                                ...
                                dplyr::slice((i+1): (i+24)) %>% pull(Power))
  fc= cbind(fc, iteration=i)
  fc_lr_20 <- bind_rows(fc_lr_20,fc)
  
  # extract fitted and residuals
  fitted_m1_20 <- fit_m1 %>% fitted() %>% as_tibble()
  residuals_m1_20 <- fit_m1 %>%  residuals() %>% as_tibble()
  res_fit_all_20 <- bind_rows(res_fit_all_20,bind_cols(fitted_m1_20,res=residuals_m1_20$.resid,iteration=i))
  
}

end_time_20 <- Sys.time()

#saveRDS(fitted_m1_20, file = "fc20_m1_lr_fitted.rds")
#saveRDS(residuals_m1_20, file = "fc20_m1_lr_residuals.rds")

saveRDS(res_fit_all_20, "res_fit_all_20.rds")
saveRDS(fc_lr_20, "fc_m1_lr_20.rds")
...
for (i in seq(N_30,N_30_all-16,16)) {
  ...
  fc <-   fit_m1 %>%
    ...
    as_tibble() %>% bind_cols(Actual= min30_n %>%
                                ...
                                dplyr::slice((i+1): (i+16) ) %>% pull(Power))
  fc= cbind(fc, iteration=i)
  fc_lr_30 <- bind_rows(fc_lr_30,fc)
...
#saveRDS(fitted_m1_30, file = "fc30_m1_lr_fitted.rds")
#saveRDS(residuals_m1_30, file = "fc30_m1_lr_residuals.rds")

saveRDS(res_fit_all_30, "res_fit_all_30.rds")
saveRDS(fc_lr_30, "fc_m1_lr_30.rds")

#fc_lr_30 <- readRDS("fc_lr_30.rds")
#res_fit_all_30 <- readRDS("res_fit_all_30.rds")
...
for (i in seq(N_40,N_40_all-12,12)) {
  ...
  fc <-   fit_m1 %>%
    ...
    as_tibble() %>% bind_cols(Actual= min40_n %>%
                                ...
                                dplyr::slice((i+1): (i+12)) %>% pull(Power))
  fc= cbind(fc, iteration=i)
  fc_lr_40 <- bind_rows(fc_lr_40,fc)
...
#saveRDS(residuals_m1_40, file = "fc40_m1_lr_residuals.rds")

saveRDS(res_fit_all_40, "res_fit_all_40.rds")
saveRDS(fc_lr_40, "fc_m1_lr_40.rds")
...
for (i in seq(N_60,N_60_all-8,8)) {
  ...
  fc <-   fit_m1 %>%
    ...
    as_tibble() %>% bind_cols(Actual= min60_n %>%
                                ...
                                dplyr::slice((i+1) : (i+8)) %>% pull(Power))
  fc= cbind(fc, iteration=i)
  fc_lr_60 <- bind_rows(fc_lr_60,fc)
...
#saveRDS(fitted_m1_60, file = "fc60_m1_lr_fitted.rds")
#saveRDS(residuals_m1_60, file = "fc60_m1_lr_residuals.rds")

saveRDS(res_fit_all_60, "res_fit_all_60.rds")
saveRDS(fc_lr_60, "fc_m1_lr_60.rds")
...
for (i in seq(N_80,N_80_all-6,6)) {
  ...
  fc <-   fit_m1 %>%
    ...
    as_tibble() %>% bind_cols(Actual= min80_n %>%
                                ...
                                dplyr::slice((i+1): (i+6)) %>% pull(Power))
  fc= cbind(fc, iteration=i)
  fc_lr_80 <- bind_rows(fc_lr_80,fc)
  
  # extract fitted and residuals
  fitted_m1_80 <- fit_m1 %>% fitted() %>% as_tibble()
  residuals_m1_80 <- fit_m1 %>%  residuals() %>% as_tibble()
  res_fit_all_80 <- bind_rows(res_fit_all_80,bind_cols(fitted_m1_80,res=residuals_m1_80$.resid,iteration=i))
  
}

#saveRDS(fitted_m1_80, file = "fc80_m1_lr_fitted.rds")
#saveRDS(residuals_m1_80, file = "fc80_m1_lr_residuals.rds")

saveRDS(res_fit_all_80, "res_fit_all_80.rds")
saveRDS(fc_lr_80, "fc_m1_lr_80.rds")
...
for (i in seq(N_120, N_120_all-4, 4)) {
  ...
  fc= cbind(fc, iteration=i)
  fc_lr_120 <- bind_rows(fc_lr_120,fc)
  
  # extract fitted and residuals
  fitted_m1_120 <- fit_m1 %>% fitted() %>% as_tibble()
  residuals_m1_120 <- fit_m1 %>%  residuals() %>% as_tibble()
  res_fit_all_120 <- bind_rows(res_fit_all_120,bind_cols(fitted_m1_120,res=residuals_m1_120$.resid,iteration=i))
  
}

end_time_120 <- Sys.time()

#saveRDS(fitted_m1_120, file = "fc120_m1_lr_fitted.rds")
#saveRDS(residuals_m1_120, file = "fc120_m1_lr_residuals.rds")

saveRDS(res_fit_all_120, "res_fit_all_120.rds")
saveRDS(fc_lr_120, "fc_m1_lr_120.rds")
fc_lr_120_old <- readRDS("fc_m1_lr_120.rds")
...
for (i in seq(N_160, N_160_all-3, 3)) {
  ...
  fc <-   fit_m1 %>%
    ...
    as_tibble() %>% bind_cols(Actual= min160_n %>%
                                ...
                                dplyr::slice((i+1): (i+3)) %>% pull(Power))
  fc= cbind(fc, iteration=i)
  fc_lr_160 <- bind_rows(fc_lr_160,fc)
...
#saveRDS(fitted_m1_160, file = "fc160_m1_lr_fitted.rds")
#saveRDS(residuals_m1_160, file = "fc160_m1_lr_residuals.rds")

saveRDS(res_fit_all_160, "res_fit_all_160.rds")
saveRDS(fc_lr_160, "fc_m1_lr_160.rds")
...
# compute number of entries
N_240 = nrow(min240_n %>% filter(as.Date(Time) < "2021-01-01"))/n_keys(min240_n %>%
                      filter(as.Date(Time) < "2021-01-01"))
N_240_all = nrow(min240_n)/n_keys(min240_n)

fc_lr_240 <- NULL;
res_fit_all_240 <- NULL
...
for (i in seq(N_240,N_240_all-2,2)) {
  ...
  fc <-   fit_m1 %>%
    ...
    as_tibble() %>% bind_cols(Actual= min240_n %>%
                                ...
                                dplyr::slice(i+1, i+2) %>% pull(Power))
  fc= cbind(fc, iteration=i)
  fc_lr_240 <- bind_rows(fc_lr_240,fc)
  
  # extract fitted and residuals
  fitted_m1_240 <- fit_m1 %>% fitted() %>% as_tibble()
  residuals_m1_240 <- fit_m1 %>%  residuals() %>% as_tibble()
  res_fit_all_240 <- bind_rows(res_fit_all_240,bind_cols(fitted_m1_240,res=residuals_m1_240$.resid,iteration=i))
  
}

#saveRDS(fitted_m1_240, file = "fc240_m1_lr_fitted.rds")
#saveRDS(residuals_m1_240, file = "fc2400_m1_lr_residuals.rds")

saveRDS(res_fit_all_240, "res_fit_all_lr_240.rds")
saveRDS(fc_lr_240, "fc_m1_lr_240.rds")
...
for (i in seq(N_480,N_480_all-1,1)) {
  ...
  fc= cbind(fc, iteration=i)
  fc_lr_480 <- bind_rows(fc_lr_480,fc)
...
#saveRDS(residuals_m1_480, file = "fc480_m1_lr_residuals.rds")

saveRDS(res_fit_all_480,"res_fit_all_lr_480.rds")
saveRDS(fc_lr_480,"fc_m1_lr_480.rds")
